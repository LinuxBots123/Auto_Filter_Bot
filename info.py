...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Linux_Bots') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Linux_Bots') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Linux_Bots') # Update channel link for the bot
